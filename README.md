...
该模块抛出了一个构造函数：PubSub，该构造函数是通过createClass()函数（https://github.com/yunfour/createClass）创建的，通过createClass()函数创建的构造函数的实例都会拥有：setAttr()、getAttr()、instanceOf()三个方法，这三个方法的作用，请参考https://github.com/yunfour/createClass这个模块的说明。除了这三个方法，该构造函数还提供以下几个方法：
